...
for file in os.listdir(source_folder):
    ...
    if file.endswith(".jpg") or file.endswith(".jpeg") or file.endswith(".png"):
        ...
        # Enhance the colors of the image and add the watermark
        add_watermark(img, watermark_path, destination_folder)

    # Show a message to indicate that the process is complete
print("Watermark added and colors enhanced for the images in the source folder and saved in the destination folder")
